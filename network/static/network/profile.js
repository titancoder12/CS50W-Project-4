    ...
    .then((myresult)=>{
        ...
        for (let i = 0; i < myresult.length; i++){
            ...
            //});
                ...
                postdiv.innerHTML = `<div class="card-body ms-2"><h5 class="ms-2"><a href="/profile/${myresult[i]["user_id"]}">${myresult[i]["user"]}</a></h5>${myresult[i].text}<hr><p style="color: rgb(211, 211, 211)">${myresult[i].timestamp}</p></div>`;
